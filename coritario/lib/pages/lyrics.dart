...
class LyricsPage extends StatelessWidget {
  ...
  const LyricsPage({super.key, this.songs, this.numbers, this.titles, this.lyrics, this.chords, this.index});
    ...
    child: Container(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          ...
          children: [
            IconButton(
              icon: const Icon(Icons.music_note, color: Color.fromRGBO(240, 243, 255, 1), 
              size: 35),
              onPressed: () {
                // Add functionality for the search button
                Navigator.push(
      ...
      body: GestureDetector(
        onTap: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => LyricsFullPage(songs: songs, numbers: numbers, titles: titles, lyrics: lyrics, chords: chords, index: index,)));
        },
        child: Center(
          child: Padding(
